...
package com.pinkunicorp.scannertest.filter;

import java.util.*;

import android.graphics.Rect;

import com.pinkunicorp.scannertest.filter.math.Function2D;
import com.pinkunicorp.scannertest.filter.math.ImageMath;
import com.pinkunicorp.scannertest.filter.math.Noise;
import com.pinkunicorp.scannertest.filter.util.PixelUtils;
